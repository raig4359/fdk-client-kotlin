...
interface CatalogApiList {
    ...
    fun getProducts(@Path("company_id") companyId: String, @Query("brand_ids") brandIds: ArrayList<Double>?, @Query("category_ids") categoryIds: ArrayList<Double>?, @Query("q") q: String?, @Query("page_no") pageNo: Int?, @Query("page_size") pageSize: Int?)
    ...
    @GET ("/service/platform/catalog/v1.0/company/{company_id}/products/<item_id:int>/sizes/<size_identifier>")
...
interface InventoryApiList {
    ...
    fun getJobCodeMetrics(@Path("company_id") companyId: String, @Path("code") code: String)
