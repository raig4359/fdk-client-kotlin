...
class CatalogDataManagerClass(val config: PlatformConfig) : BaseRepository() {        
    ...
    suspend fun getProducts(brandIds: ArrayList<Int>?=null, categoryIds: ArrayList<Int>?=null, departmentIds: ArrayList<Int>?=null, itemIds: ArrayList<Double>?=null, itemCode: ArrayList<Double>?=null, q: String?=null, pageNo: Int?=null, pageSize: Int?=null)
...
class InventoryDataManagerClass(val config: PlatformConfig) : BaseRepository() {        
    ...
    suspend fun getJobCodeMetrics(code: String, pageNo: Int?=null, pageSize: Int?=null, date: String?=null)
    : Deferred<Response<ResponseEnvelopeJobMetricsDto>>? {
        
        return if (config.oauthClient.isAccessTokenValid()) {
            inventoryApiList?.getJobCodeMetrics(
        companyId = config.companyId, code = code, pageNo = pageNo, pageSize = pageSize, date = date )
        } else {
            null
        } 
    }
